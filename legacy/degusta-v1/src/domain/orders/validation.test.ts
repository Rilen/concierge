...
describe("C1 — Server-Side Product Options Validation", () => {
  ...
  it("3. quantidade acima de maxSelect → REJEITAR", () => {
    // Selecting 3 additions when maxSelect is 2
  ...
  it("4. quantidade dentro do limite → ACEITAR", () => {
    // Selecting 2 additions when maxSelect is 2
    const result = validateProductOptionSelections(
      sampleProduct,
